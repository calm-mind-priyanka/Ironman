...
async def add_premium_cmd(client: Client, message: Message):
    try:
        ...
        logger.error("🚨 [CRITICAL COMMAND ERROR in admin.py]: /add_premium failed", exc_info=True)
...
async def remove_premium_cmd(client: Client, message: Message):
    try:
        ...
        logger.error("🚨 [CRITICAL COMMAND ERROR in admin.py]: /remove_premium failed", exc_info=True)
        await message.reply_text("⚠️ An internal error occurred while processing this command.")
...
async def broadcast_cmd(client: Client, message: Message):
    try:
        ...
        logger.error("🚨 [CRITICAL COMMAND ERROR in admin.py]: /broadcast failed", exc_info=True)
